...
$query = 'SELECT * FROM User U LEFT JOIN Zipcode Z ON U.zipcode_id = Z.zipcode_id WHERE user_id = "'.$id.'"';
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-xs-12 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="scripts/processUpdateUser.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="tel" class="form-control" name="phone" value="<?php echo $phone; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="address" class="col-md-4 col-form-label text-md-right">Address</label>
                                <div class="col-md-6">
                                    <input id="address" type="text" class="form-control" name="address" value="<?php echo $address; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="zipcode" class="col-md-4 col-form-label text-md-right">City, State, Zip</label>
                                <div class="col-md-6">
                                    <select name="zipcode" id="zipcode" class="form-control form-control-chosen" required>
                                            <?php
                                            if ($zipcode == NULL) {
                                                echo '<option selected disabled>Please Select a City, State, Zipcode</option>';
                                            } else {
                                                echo '<option value="'.$zipcode_id.'">'.$city.', '.$state.' '.$zipcode.'</option>';
                                            }
                                            ?>
