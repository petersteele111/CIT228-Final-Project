...
if (isset($_FILES["userFile"]) && $_FILES["userFile"]["name"]) {
    $sql = 'INSERT INTO Movie (studio_id, movie_name, movie_release_date, movie_description, movie_image_location, movie_thumbnail) VALUES ('.$studio.', "'.$movie_name.'", "'.$movie_release_date.'", "'.$movie_description.'", "'.$movie_image.'", "'.$movie_thumbnail.'" )';
} else {
    $sql = 'INSERT INTO Movie (studio_id, movie_name, movie_release_date, movie_description) VALUES ('.$studio.', "'.$movie_name.'", "'.$movie_release_date.'", "'.$movie_description.'")';
}
...
if (!$connection->query($sql)) {
    ...
    header("location: https://cit228.pbsteele.com/FinalProject/CRUD/view/movie/viewAll.php");
}
