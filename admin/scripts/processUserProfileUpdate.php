<?php
require_once 'verifyIsLoggedIn.php';
...
if (isset($_POST["submit"])) {
    ...
    $sql = 'UPDATE User SET zipcode_id = '. $zipcode_id . ', user_first_name = "'. $user_first_name . '", user_last_name = "' . $user_last_name . '", user_email = "' . $user_email . '", user_phone = "' .$user_phone . '", user_address = "' . $user_address . '" WHERE user_id = ' . $_SESSION["id"];
